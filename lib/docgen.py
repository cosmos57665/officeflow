"""Document generation helpers: Word minutes, certificates and progress reports."""
...
def progress_report_pdf(name: str, context: str, score: str, progress: str,
                        remark: str, out_path):
    """Write a structured A4 progress report that does not look like a certificate."""
    pdf = FPDF(orientation="P", unit="mm", format="A4")
    ...
    pdf.set_xy(16, 7)
    pdf.cell(0, 8, "Progress Report", new_x="LMARGIN", new_y="NEXT")
    pdf.set_font("Helvetica", "", 9)
    pdf.set_x(16)
    pdf.cell(0, 5, "Generated by OfficeFlow", new_x="LMARGIN", new_y="NEXT")

    pdf.set_text_color(17, 24, 39)
    pdf.set_y(36)
    pdf.set_font("Helvetica", "B", 22)
    pdf.cell(0, 10, _latin1(name), new_x="LMARGIN", new_y="NEXT")
    ...
    pdf.cell(88, 8, "Department / Class", border=1)
    pdf.cell(88, 8, "Performance Score", border=1, new_x="LMARGIN", new_y="NEXT")
    pdf.set_font("Helvetica", "", 11)
    pdf.cell(88, 9, _latin1(context or "Not specified"), border=1)
    pdf.cell(88, 9, _latin1(score or "Not specified"), border=1, new_x="LMARGIN", new_y="NEXT")

    def section(title: str, body: str):
        pdf.ln(10)
        pdf.set_fill_color(232, 243, 241)
        pdf.set_text_color(15, 118, 110)
        pdf.set_font("Helvetica", "B", 12)
        pdf.cell(0, 9, title, fill=True, new_x="LMARGIN", new_y="NEXT")
        pdf.set_text_color(17, 24, 39)
        pdf.set_font("Helvetica", "", 11)
        pdf.multi_cell(0, 7, _latin1(body or "Not specified"))

    section("Progress Summary", progress)
    section("Manager / Teacher Remarks", remark)
    section(
        "Recommended Follow-up",
        "Review progress in the next cycle, note support needed, and update goals based on this report.",
    )

    pdf.set_y(-22)
    pdf.set_text_color(100, 116, 139)
    pdf.set_font("Helvetica", "I", 9)
    pdf.cell(0, 6, "OfficeFlow progress report - internal review document", align="C")
